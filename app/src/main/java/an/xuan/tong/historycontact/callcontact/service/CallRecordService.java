package an.xuan.tong.historycontact.callcontact.service;
...
import an.xuan.tong.historycontact.callcontact.CallRecProcessingNotification;
import an.xuan.tong.historycontact.callcontact.receiver.IProcessing;
import an.xuan.tong.historycontact.callcontact.receiver.CallRecord;
...
public class CallRecordService extends Service {
    ...
    public void onCreate() {
      ...
      /*  NotificationManager notificationManager = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
        ...
        processing =new CallRecProcessingNotification(this);
        processing.onCreate();
    }
    ...
    public int onStartCommand(Intent intent, int flas, int startId) {
       ...
       mCallRecord.startCallReceiver();
        processing.onStartCommand( intent,  flas,  startId);
